...
const AddProduct = () => {
    ...
    const handleAddProduct = (e) => {
        ...
        const myData = { name, type, price, image, rating, brandName };
        console.log(myData)
    ...
    return (
        <div >
            <h2 className="text-6xl font-bold text-center py-24">add product</h2>
            ...
            <form onSubmit={handleAddProduct} className="max-w-md mx-auto">
                ...
                <div className="relative z-0 w-full mb-5 group">
                    <input type="text" name="type" id="floating_repeat_password" className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
